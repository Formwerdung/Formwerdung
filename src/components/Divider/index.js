...
const dividerTextString = `@apply px-1x py-2x py-4x text-white text-right font-semibold relative z-10 m-0 text-shadow`

const dividerIconString = `@apply h-8x h-12x py-3x py-5x stroke-current text-white relative z-10`
